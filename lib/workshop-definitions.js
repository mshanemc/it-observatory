...
const workshops = [
  ...
  },
  {
    ...
    name: 'Put into Action the Lightning Configuration Converter to Move JavaScript Buttons & Actions to Lightning Experience',
  ...
  },
  {
    ...
    name: 'From Visualforce Report to Lightning Stylesheets, Make Visualforce Pages Lightning Experience Ready!',
...
module.exports = {
  ...
  df18rapids: ['automate', 'lightning_features', 'crash_course', 'reporting'],
  demos: ['demo_extend_crm', 'demo_integrate', 'demo_ducati_heroku', 'demo_grocery'],
  df18campground: ['df18cg1'],
