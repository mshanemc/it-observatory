...
const workshops = [
  ...
  },
  {
    ...
    docsURL: 'https://salesforce.quip.com/mNhQANbRDreu'
  },
  {
    ...
    docsURL: 'https://salesforce.quip.com/NiOSAK5xyOkA'
  },
  {
    shortname: 'go_live',
    ...
    docsURL: 'https://salesforce.quip.com/FdUPAHzg1719'
  },
  {
    ...
    docsURL: 'https://salesforce.quip.com/jwd3A9BT8msO'
  },
  {
  ...
  },
  {
    ...
    name: 'Build Custom Digital Experiences',
  ...
  },
  {
    ...
    description: 'IoT orchestrations, context, and platform events help track scheduled maintenance for a customer\'s Volvo.  Plus prediction builder!',
  ...
  },
  {
    ...
    description: 'Sandboxes, Change Sets, Deployment Connections, Permissions, Encryption, Transaction Security',
...
module.exports = {
  ...
  main: ['automate', 'heroku_connect', 'lightning_features', 'code_for_clicks', 'crash_course', 'agility', 'employee_community', 'audiences', 'reporting'],
  daydreamin: ['reporting', 'lightning_features', 'code_for_clicks'],
  df18zone: ['agility', 'heroku_connect', 'code_for_clicks', 'iot', 'crash_course', 'lightning_vf', 'js_buttons'],
  df18rapids: ['automate', 'agility', 'crash_course', 'reporting'],
  demos: ['demo_extend_crm', 'demo_integrate', 'demo_ducati_heroku', 'demo_grocery'],
  df18campground: ['demo_volvo_low_code', 'demo_volvo_lea', 'demo_dubsmash', 'demo_volvo_iot', 'demo_volvo_trust'],
