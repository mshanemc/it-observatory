...
const workshops = [
  {
    ...
    description: 'Lightning Web Components (LWC) launched with a bang. Whether you have used them before or are brand new, join this workshop to learn five ways LWC improve developer productivity.',
    launchURL: launcher_pre + 'https://github.com/mshanemc/lwc-workshop',
...

  {
    ...
    description: 'Want to use the power of Einstein in your custom apps? Learn how to take your current objects and data in Salesforce, and build predictions based on them.  No code or data science experience required.',
    launchURL: launcher_pre + 'https://github.com/mshanemc/epb-workshop',
    docsURL: 'https://salesforce.quip.com/y5vLA36vwtao'

  },
	{
		shortname: 'flows',
    name: 'Learn New Tricks for the New Flow Builder',
    description: 'Get hands-on with the new Flow Builder, explore new features, and learn new tricks you may not know Flows could do.',
    ...
    description: 'In this workshop, you will get hands on with a Console App and learn how to maximize user productivity through features like Console navigation, Quick Text and Macros.',
  ...
  },
  {
    ...
    launchURL: launcher + 'https://github.com/mshanemc/DF17integrationWorkshops&email=required',
    docsURL: 'https://org62.my.salesforce.com/sfc/p/000000000062/a/0M000000Fke0/qHS6AQaBdz_7pDvaONSbuuv4Hjgx87xjN3dGIVepuXA'
  },
  {
    shortname: 'cdc',
    name: 'Change Data Capture (CDC)',
    description: 'Salesforce has enabled a bunch of new features for Event Driven Architectures.  During this workshop, we\'ll activate Change Data Capture and use change events in 3 different scenarios: reactive Salesforce UIs, asynchronous triggers, and apps running outside of Salesforce.',
    launchURL: launcher_pre + 'https://github.com/mshanemc/cdc-workshop',
  ...
  },
  {
    ...
    description: 'Salesforce CPQ is providing you an opportunity for an in-depth hands-on walkthrough of Salesforce CPQ. The workshop will give you first-hand experience in administering Salesforce CPQ as we walk through a series of hands-on exercises in the product so you can learn how to leverage the Salesforce platform to take your business to the next level.',
  ...
  },
  {
    ...
    description: 'Electron Motors branded demo of SSO/Aloha, a chatter-powered intranet, Cadalys Concierge, and employee apps (org chart and safety reporting).  There\'s even a story for the BRK',
    ...
    launchURL: launcher + 'https://github.com/gabesumner/solutions-departmental-apps'
	},
...
module.exports = {
  ...
  tdxadoption: ['flows_simple', 'go_live', 'js_buttons', 'console_apps'],
