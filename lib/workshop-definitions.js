...
module.exports = {
  ...
  df18rapids: ['automate', 'agility', 'crash_course'],
  df18adoption: ['adoption_sales', 'adoption_service', 'go_live', 'quick_actions'],

  adoption: ['adoption_sales', 'adoption_service', 'go_live', 'quick_actions', 'lightning_features', 'lightning_vf', 'js_buttons'],
