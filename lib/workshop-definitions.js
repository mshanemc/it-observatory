...
module.exports = {
  ...
  // demo stuff
  demos: ['easy_spaces', 'demo_extend_crm', 'demo_integrate', 'demo_ducati_heroku', 'demo_grocery', 'demo_encryption'],
  df18campground: ['demo_volvo_low_code', 'demo_volvo_lea', 'demo_dubsmash', 'demo_volvo_trust', 'demo_align_heroku', 'demo_sfdx_mulesoft'],

  broken: ['iot_workshop'],
  brokenDemos: ['demo_volvo_iot', 'iot']
};