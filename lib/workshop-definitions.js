...
module.exports = {
  ...
  all: ['automate', 'heroku_connect', 'lightning_features', 'code_for_clicks', 'crash_course', 'agility', 'reporting', 'adoption_sales', 'adoption_service', 'go_live', 'quick_actions', 'lightning_vf', 'js_buttons', 'heroku_pipelines'],
