...
module.exports = {
  ...
  all: ['automate', 'heroku_connect', 'lightning_features', 'code_for_clicks', 'crash_course', 'agility', 'adoption_sales', 'adoption_service', 'go_live', 'quick_actions', 'lightning_vf', 'js_buttons', 'heroku_pipelines'],
  main: ['automate', 'heroku_connect', 'lightning_features', 'code_for_clicks', 'crash_course', 'agility'],

  df18zone: ['agility', 'heroku_connect', 'code_for_clicks', 'crash_course', 'lightning_vf', 'js_buttons', 'heroku_pipelines'],
  df18rapids: ['automate', 'agility', 'crash_course', 'reporting'],
  df18adoption: ['adoption_sales', 'adoption_service', 'go_live', 'quick_actions'],

  sfwt: ['crash_course', 'automate', 'heroku_connect'],
  avalon: ['crash_course', 'automate', 'heroku_connect'],

  daydreamin: ['reporting', 'lightning_features', 'code_for_clicks'],

  adoption: ['adoption_sales', 'adoption_service', 'reporting', 'go_live', 'quick_actions', 'lightning_features', 'lightning_vf', 'js_buttons'],

  // demo stuff
  demos: ['easy_spaces', 'demo_extend_crm', 'demo_integrate', 'demo_ducati_heroku', 'demo_grocery', 'demo_encryption', 'demo_rviot'],
  df18campground: ['demo_volvo_low_code', 'demo_volvo_lea', 'demo_volvo_iot', 'demo_dubsmash', 'demo_volvo_trust', 'demo_align_heroku', 'demo_sfdx_mulesoft'],
